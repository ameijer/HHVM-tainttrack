...
public:
  ...
  void popX() {
    ...
    tvDebugTrash(m_top);
    memset(m_top, 0, 1 * sizeof(TypedValue));
    m_top++;
  }
  ...
  void discardAR() {
    ...
    memset(m_top, 0, kNumActRecCells * sizeof(TypedValue));
  ...
  void ret() {
    ...
    memset(m_top, 0, (kNumActRecCells -1) * sizeof(TypedValue));
  ...
  void ndiscard(size_t n) {
    ...
    //ameijer
    memset(m_top, 0, n * sizeof(TypedValue));
