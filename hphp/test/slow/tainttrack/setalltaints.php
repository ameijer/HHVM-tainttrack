...
assert(gettaints($a) == ( - 1), "Retrieved taint for \$a does not match.");
assert(gettaints($b) == ( - 1), "Retrieved taint for \$b does not match.");
assert(gettaints($c) == ( - 1), "Retrieved taint for \$c does not match.");
assert(gettaints($d) == ( - 1), "Retrieved taint for \$d does not match.");
assert(gettaints($e) == ( - 1), "Retrieved taint for \$e does not match.");
assert(gettaints($f) == ( - 1), "Retrieved taint for \$f does not match.");
assert(gettaints($g) == ( - 1), "Retrieved taint for \$g does not match.");
